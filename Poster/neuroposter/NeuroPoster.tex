...
\begin{columns}[t]
	 ...
	 \begin{column}{0.46\linewidth}
	 	...
	 	\begin{figure}[H]
	 		\centering
	 		\subfigure{\includegraphics[scale=0.4]{../graphics/proto1}}
	 		\subfigure{\includegraphics[scale=0.4]{../graphics/proto2}}
	 		\subfigure{\includegraphics[scale=0.4]{../graphics/proto3}}
	 		\subfigure{\includegraphics[scale=0.4]{../graphics/proto4}}
	 		\subfigure{\includegraphics[scale=0.4]{../graphics/proto5}}
	 		\caption{Prototipo}
	 	\end{figure}
